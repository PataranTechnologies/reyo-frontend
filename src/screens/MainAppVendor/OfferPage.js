...
import CustomOfferHeader from '../../navigations/CustomOfferHeader';
...
<CustomOfferHeader title={"Store name"} openEditPage={openEditPage} nonNavigationHeader={true} back={props.onBack} navigation={props.navigation} />
