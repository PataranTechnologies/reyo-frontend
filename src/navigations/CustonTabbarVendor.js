...
const CustomTabbarVendor=(props)=>{
...
<TouchableWithoutFeedback onPress={()=>{handleItemClick(1)}}>
            <View style={[styles.tabItem,selectedTab===1?styles.selectedContainer:styles.notSelectedConntainer]}>
                ...
                <Icon name="shopping-store" style={selectedTab===1?styles.selectedI:styles.notSelectedI} />

                <Text style={selectedTab===1?styles.selected:styles.notSelected}>My Store</Text>
...
<TouchableWithoutFeedback onPress={()=>{handleItemClick(2)}}>
                ...
                <Text style={selectedTab===2?styles.selected:styles.notSelected}>My Offers</Text>
...
<TouchableWithoutFeedback onPress={()=>{handleItemClick(3)}}>
                ...
                <Icon2 name="sharealt" style={selectedTab===3?styles.selectedI:styles.notSelectedI} />

                <Text style={selectedTab===3?styles.selected:styles.notSelected}>Share</Text>
            ...
            <View style={[styles.tabItem,selectedTab===4?styles.selectedContainer:styles.notSelectedConntainer]}>
                ...
                <Icon2 name="setting" style={selectedTab===4?styles.selectedI:styles.notSelectedI} />

                <Text style={selectedTab===4?styles.selected:styles.notSelected}>Setting</Text>
...
export default CustomTabbarVendor